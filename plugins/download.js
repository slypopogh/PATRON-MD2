...
cmd({
  ...
  try {
    ...
    const response = await axios.get(`https://https://apis.davidcyriltech.my.id/instagram?url=${q}`);
...
cmd({
  ...
  category: "download",
  filename: __filename,
  use: ".twitter <Twitter video link>"
}, async (conn, m, store, {
  from,
  quoted,
  q,
...
cmd({
  ...
  category: "download",
  filename: __filename,
  use: ".mediafire <MediaFire file link>"
}, async (conn, m, store, {
  from,
  quoted,
  q,
...
cmd({
  ...
  category: "download",
  filename: __filename,
  use: ".gdrive <Google Drive file link>"
}, async (conn, m, store, {
  from,
  quoted,
  q,
